...
// Routes for checking menu item availability
router.get('/recipes/check-availability/:menuItemId', kitchenOrAdmin, recipeController.checkAndUpdateMenuItemAvailability);
router.get('/recipes/check-all-availability', kitchenOrAdmin, recipeController.checkAllMenuItemsAvailability);
