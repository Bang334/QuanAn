    ...
    for (const item of orderItems) {
      ...
      for (const recipe of recipeIngredients) {
        ...
        await ingredient.update({
          currentStock: sequelize.literal(`currentStock - ${usedQuantity}`)
        }, { transaction });
        ...
        const updatedQuantity = parseFloat(ingredient.currentStock) - parseFloat(usedQuantity);
        if (updatedQuantity < parseFloat(ingredient.minStockLevel)) {
