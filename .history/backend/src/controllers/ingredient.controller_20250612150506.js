...
exports.updateIngredient = async (req, res) => {
  try {
    const { id } = req.params;
    const { name, description, unit, currentQuantity, alertThreshold, unitPrice, supplierId } = req.body;
...
// Delete ingredient (actual delete since we don't have isActive field)
