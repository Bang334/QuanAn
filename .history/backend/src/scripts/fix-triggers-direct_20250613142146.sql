...
-- Tạo lại trigger before_order_item_insert_update
...
-- Tạo lại trigger before_order_item_status_update
...
-- Tạo lại trigger before_order_status_update
