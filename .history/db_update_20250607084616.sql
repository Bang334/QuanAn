...
INSERT INTO tables (table_number, capacity, status, location, createdAt, updatedAt)
SELECT '1', 4, 'available', 'Tầng 1', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM tables WHERE table_number = '1');

INSERT INTO tables (table_number, capacity, status, location, createdAt, updatedAt)
SELECT '2', 2, 'available', 'Tầng 1', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM tables WHERE table_number = '2');

INSERT INTO tables (table_number, capacity, status, location, createdAt, updatedAt)
SELECT '3', 6, 'available', 'Tầng 1', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM tables WHERE table_number = '3');

INSERT INTO tables (table_number, capacity, status, location, createdAt, updatedAt)
SELECT '4', 4, 'available', 'Tầng 2', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM tables WHERE table_number = '4');

INSERT INTO tables (table_number, capacity, status, location, createdAt, updatedAt)
SELECT '5', 8, 'available', 'Tầng 2', NOW(), NOW()
