...
// Tạm thời sử dụng danh mục cứng vì backend chưa có API categories
export const getAllCategories = async () => {
  // Trả về danh sách danh mục cứng
  return [
    { id: 1, name: 'Thịt', description: 'Các loại thịt tươi sống' },
    { id: 2, name: 'Hải sản', description: 'Các loại hải sản tươi sống' },
    { id: 3, name: 'Rau củ', description: 'Các loại rau, củ, quả' },
    { id: 4, name: 'Gia vị', description: 'Các loại gia vị' },
    { id: 5, name: 'Đồ khô', description: 'Các loại thực phẩm khô' },
    { id: 6, name: 'Đồ uống', description: 'Các loại đồ uống' }
  ];
};
