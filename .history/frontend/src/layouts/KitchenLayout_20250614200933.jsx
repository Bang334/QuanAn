    ...
    <Box sx={{ display: 'flex' }}>
        ...
        <Toolbar>
          ...
          <div>
            ...
            <Menu
              ...
              onClose={handleClose}
              slotProps={{ paper: { 'data-testid': 'menu-paper' } }}
              // MUI v5 preferred way to pass data-testid without ref warnings
            >
              <MenuItem disabled>
      ...
      >
        ...
        <Drawer
          ...
          // Loại bỏ componentsProps vì không còn được hỗ trợ trong React 19
        >
          {drawer}
        </Drawer>
        {/* Desktop drawer */}
        <Drawer
          ...
          open
          // Use componentsProps instead of slotProps to avoid React 19 ref warnings
          componentsProps={{ backdrop: { 'data-testid': 'permanent-drawer-backdrop' } }}
        >
          {drawer}
        </Drawer>
      </Box>
