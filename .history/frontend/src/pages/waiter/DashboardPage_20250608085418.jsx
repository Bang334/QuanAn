          ...
          <Grid item xs={6} sm={4} md={3} lg={2} key={table.id}>
            <Paper 
              sx={{ 
                ...
                alignItems: 'center',
                borderTop: `4px solid ${theme.palette[getTableStatusColor(table.status)].main}`
              }}
            >
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2, alignItems: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      <Avatar sx={{ bgcolor: theme.palette[getStatusColor(order.status)].main, mr: 1 }}>
                        <Typography variant="body2">{order.tableId}</Typography>
                      </Avatar>
                    ...
                    {order.OrderItems.map((item) => (
                      ...
                      >
                        ...
                        <ListItemText
                          primary={
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                              <Typography variant="body2" fontWeight={item.status === 'ready' ? 'bold' : 'normal'}>
