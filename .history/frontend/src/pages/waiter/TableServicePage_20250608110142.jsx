                        ...
                        {table.order.status === 'completed' && (
                          <Chip
                            ...
                            label={`Đã thanh toán (${table.order.paymentMethod === 'cash' ? 'Tiền mặt' : 
                              table.order.paymentMethod === 'card' ? 'Thẻ' : 
                              table.order.paymentMethod === 'momo' ? 'MoMo' : 
                              table.order.paymentMethod === 'zalopay' ? 'ZaloPay' : 
                              table.order.paymentMethod === 'vnpay' ? 'VNPay' : 'Không xác định'})`}
                            color="success"
                            size="small"
                          />
                        )}
