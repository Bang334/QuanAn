              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body1">
                    {order.User ? order.User.name : 'Không có thông tin'}
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="body2" color="text.secondary">
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="body1">{order.note || 'Không có ghi chú'}</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="body2" color="text.secondary">
                    Tổng tiền
          ...
          <Card variant="outlined" sx={{ height: '100%' }}>
            <CardContent>
              ...
              {order.status === 'shipping' && (
                <Alert severity="info" sx={{ mb: 2 }}>
                  Đơn hàng đang được giao. Bạn có thể cập nhật trạng thái khi đã nhận được hàng.
                </Alert>
              )}
