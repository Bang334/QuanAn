...
export const IngredientHistoryPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('Dữ liệu lịch sử tồn kho:', historyData);
    ...
    return (
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        <Button
          ...
          startIcon={<ArrowBack />}
          onClick={() => {
            // Kiểm tra URL hiện tại để xác định quay lại trang nào
  ...
  // Đảm bảo dữ liệu biểu đồ hợp lệ
      ...
      <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        <Box display="flex" alignItems="center" mb={3}>
          ...
          <Typography variant="h4" component="h1">
            Lịch sử nguyên liệu: {ingredient?.name || 'Không xác định'}
          </Typography>
        </Box>
        <Alert severity="info" sx={{ mb: 3 }}>
          Không có dữ liệu lịch sử tồn kho cho nguyên liệu này.
        </Alert>
      </Container>
    );
  }
