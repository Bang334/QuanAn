    ...
    try {
      ...
      const orderData = {
        ...
        items: orderForm.items.map(item => {
          const ingredient = ingredients.find(ing => ing.id === parseInt(item.ingredientId));
          return {
            ingredientId: parseInt(item.ingredientId),
            quantity: parseFloat(item.quantity),
            unitPrice: ingredient ? parseFloat(ingredient.costPerUnit) : 0
          };
        }),
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
              <FormLabel component="legend" sx={{ mb: 1, fontWeight: 'medium' }}>Nhà cung cấp</FormLabel>
              <Select
                name="supplierId"
          ...
          <Grid item xs={12} md={6}>
            <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
              <FormLabel component="legend" sx={{ mb: 1, fontWeight: 'medium' }}>Ngày giao hàng dự kiến</FormLabel>
              <TextField
                type="date"
          ...
          <Grid item xs={12}>
            <FormControl fullWidth variant="outlined">
              <FormLabel component="legend" sx={{ mb: 1, fontWeight: 'medium' }}>Ghi chú</FormLabel>
              <TextField
                name="notes"
          ...
          <Grid item xs={12}>
            <Box sx={{ mt: 4, mb: 2 }}>
              <Typography variant="h6" component="div" sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                <FastfoodOutlined sx={{ mr: 1 }} color="primary" /> Danh sách nguyên liệu
              </Typography>
                  ...
                  <Box key={index} sx={{ mb: 2, p: 2, border: '1px solid #e0e0e0', borderRadius: 1 }}>
                    <Grid container spacing={2} alignItems="center">
                      <Grid item xs={12} md={5}>
                        <FormControl fullWidth variant="outlined">
                          <FormLabel component="legend" sx={{ mb: 1, fontWeight: 'medium' }}>Nguyên liệu</FormLabel>
                          <Select
                            name="ingredientId"
                      ...
                      <Grid item xs={12} md={5}>
                        <FormControl fullWidth variant="outlined">
                          <FormLabel component="legend" sx={{ mb: 1, fontWeight: 'medium' }}>Số lượng</FormLabel>
                          <TextField
                            type="number"
                            name="quantity"
                            value={item.quantity}
