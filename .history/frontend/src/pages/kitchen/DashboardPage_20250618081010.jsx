...
const DashboardPage = () => {
  ...
  const [timeFilter, setTimeFilter] = useState('day'); // 'day' (24h) hoặc 'week' (7 ngày)
      ...
      <Box sx={{ minHeight: '60vh' }}>
        {filteredOrders.length === 0 ? (
          <Paper sx={{ p: 3, textAlign: 'center', minHeight: '200px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Typography>Không có đơn hàng nào {timeFilter === 'day' ? 'trong 24 giờ qua' : 'trong 7 ngày qua'}</Typography>
          </Paper>
        ) : (
    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          >
            <ToggleButton value="day" aria-label="24 giờ qua">
              <TodayIcon fontSize="small" sx={{ mr: 0.5 }} />
              <Typography variant="body2" sx={{ display: { xs: 'none', sm: 'block' } }}>24 giờ</Typography>
            </ToggleButton>
            <ToggleButton value="week" aria-label="7 ngày qua">
              <DateRangeIcon fontSize="small" sx={{ mr: 0.5 }} />
              <Typography variant="body2" sx={{ display: { xs: 'none', sm: 'block' } }}>7 ngày</Typography>
            </ToggleButton>
          </ToggleButtonGroup>
      ...
      <Box sx={{ mb: 2 }}>
        <Typography variant="body2" color="text.secondary">
          Hiển thị đơn hàng {timeFilter === 'day' ? 'trong 24 giờ qua' : 'trong 7 ngày qua'}
        </Typography>
      </Box>
