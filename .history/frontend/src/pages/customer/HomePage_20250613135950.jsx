...
const HomePage = () => {
  ...
  const handleOpenOrderHistoryDialog = () => {
  ...
  return (
    ...
    >
          ...
          >
            ...
            <Box>
              <Typography variant="body1" sx={{ mb: 2 }}>
                Đã dùng bữa tại nhà hàng? Xem lại đơn hàng và đánh giá món ăn
              </Typography>
              <Button
                variant="outlined"
                color="secondary"
                ...
                onClick={handleOpenOrderHistoryDialog}
              >
                Xem lại đơn hàng & đánh giá
              </Button>
            </Box>
          </Paper>
        </Grid>
      ...
      {/* Dialog nhập số đơn hàng */}
      <Dialog 
        open={orderHistoryDialog} 
        onClose={handleCloseOrderHistoryDialog}
        PaperProps={{
          sx: {
            borderRadius: 2,
            boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2)',
      ...
      >
        ...
        <DialogContent sx={{ pt: 3 }}>
          <Typography variant="body1" paragraph>
            Nhập mã đơn hàng của bạn để xem chi tiết và đánh giá món ăn
          </Typography>
          <TextField
            autoFocus
            margin="dense"
          ...
          />
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            Mã đơn hàng được in trên hóa đơn của bạn
          </Typography>
        </DialogContent>
        <DialogActions sx={{ px: 3, pb: 3 }}>
          <Button 
            onClick={handleCloseOrderHistoryDialog}
            variant="outlined"
            sx={{ borderRadius: 2 }}
          >
            Hủy
