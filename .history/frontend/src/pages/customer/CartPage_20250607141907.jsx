...
const CartPage = () => {
  ...
  const { cartItems, tableId, updateItemQuantity, removeItem, getTotalPrice, clearCart } = useCart();
                ...
                return (
                  <Box key={item.id}>
                      ...
                      <Grid container spacing={2}>
                          {/* Hàng 1: Hình ảnh và thông tin món ăn */}
                          <Grid item xs={12}>
                            <Grid container spacing={2}>
                              <Grid item xs={3} sm={2}>
                                <Box
                              ...
                              <Grid item xs={9} sm={10} container direction="column" spacing={0.5}>
                                <Grid item>
