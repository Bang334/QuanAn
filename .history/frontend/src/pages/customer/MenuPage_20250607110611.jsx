  ...
  return (
    <Box sx={{ width: '100vw', m: 0, p: 0, overflow: 'hidden' }}>
      ...
      {filteredItems.length === 0 ? (
        ...
        <Box sx={{ width: '100%', px: { xs: 0, sm: 1 }, mx: 0 }}>
                ...
                <Zoom in={true} style={{ transitionDelay: `${Math.min(index * 20, 150)}ms` }}>
                  <Card sx={{ 
                    ...
                    <Box sx={{ 
                      ...
                      width: '100%', 
                      height: index % 2 === 0 ? 
                        { xs: '130px', sm: '180px', md: '200px' } : 
                        { xs: '110px', sm: '180px', md: '200px' }, 
                      overflow: 'hidden' 
                    }}>
                      <CardMedia
                        component="img"
                    ...
                    <CardContent sx={{ 
                      ...
                      minHeight: index % 2 === 0 ? { xs: '70px', sm: '90px' } : { xs: '65px', sm: '90px' }
                    }}>
                      <Box>
                        <Typography 
                          variant="h6" 
                          ...
                          sx={{ 
                            fontWeight: 'bold', 
                            fontSize: index % 2 === 0 ? { xs: '0.8rem', sm: '0.9rem' } : { xs: '0.75rem', sm: '0.9rem' }, 
                            mb: 0.25, 
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.25 }}>
                          <Rating 
                            ...
                            size="small"
                            sx={{
                              fontSize: index % 2 === 0 ? { xs: '0.7rem', sm: '0.8rem' } : { xs: '0.65rem', sm: '0.8rem' }
                            }}
                          />
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 0.25 }}>
                        <Typography variant="h6" color="primary" sx={{ fontWeight: 'bold', fontSize: index % 2 === 0 ? { xs: '0.8rem', sm: '0.9rem' } : { xs: '0.75rem', sm: '0.9rem' } }}>
