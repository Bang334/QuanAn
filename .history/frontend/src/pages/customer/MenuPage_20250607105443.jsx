  ...
  return (
    <Box sx={{ width: '100vw', m: 0, p: 0, overflow: 'hidden' }}>
      ...
      {filteredItems.length === 0 ? (
        ...
        <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', p: { xs: 0.25, sm: 1 } }}>
          <Grid container spacing={0.5} sx={{ width: '100%', m: 0, p: 0, justifyContent: 'center' }}>
            {filteredItems.map((item, index) => (
              <Grid key={item.id} sx={{ width: { xs: '50%', sm: '33.333%', md: '25%' }, padding: { xs: 0.25, sm: 0.5 } }}>
                <Zoom in={true} style={{ transitionDelay: `${Math.min(index * 30, 200)}ms` }}>
                  <Card sx={{ 
                    ...
                    <Box sx={{ position: 'relative', width: '100%', height: { xs: '100px', sm: '180px', md: '200px' }, overflow: 'hidden' }}>
                      <CardMedia
                        component="img"
                    ...
                    <CardActions sx={{ p: { xs: 0.5, sm: 1 }, pt: 0, justifyContent: 'center', height: { xs: '36px', sm: '50px' } }}>
                      <Stack direction="row" spacing={0.5} width="100%">
                        ...
                        >
                          {isMobile ? <AddIcon sx={{ fontSize: '0.8rem' }} /> : "Thêm vào giỏ"}
                        </Button>
                      </Stack>
                    </CardActions>
                  </Card>
