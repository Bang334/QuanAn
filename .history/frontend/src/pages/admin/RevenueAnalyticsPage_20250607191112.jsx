...
import { Container, Row, Col, Card, Button, Form, Spinner, Alert, Tabs, Tab, Box } from 'react-bootstrap';
import { 
      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          {categoryData && categoryData.length > 0 ? (
            ...
            <Box className="d-flex align-items-center justify-content-center" style={{ height: '400px' }}>
