...
const AdminAttendancePage = () => {
  ...
  // Các state lưu trữ bộ lọc riêng biệt cho từng bảng
  ...
  // Effect để cập nhật options của ca làm việc khi thay đổi ngày
  useEffect(() => {
    // Chỉ trigger khi modal đang hiển thị và có một date được chọn
    if (isScheduleModalVisible) {
      const selectedDate = scheduleForm.getFieldValue('date');
      if (selectedDate) {
        // Force re-render của Select bằng cách đặt lại giá trị
        const currentShift = scheduleForm.getFieldValue('shift');
        if (currentShift && isShiftDisabled(currentShift, selectedDate)) {
          scheduleForm.setFieldsValue({ shift: undefined });
        }
        
        // Thông báo cho người dùng nếu có ca bị disable
        if (isShiftDisabled('morning', selectedDate) || 
            isShiftDisabled('afternoon', selectedDate) || 
            isShiftDisabled('evening', selectedDate) || 
            isShiftDisabled('night', selectedDate)) {
          message.info('Một số ca làm việc không khả dụng do ràng buộc về thời gian');
        }
      }
    }
  }, [isScheduleModalVisible, scheduleForm.getFieldValue('date')]);
  ...
  const scheduleColumns = [
    {
        ...
        <div style={{ padding: 8, maxHeight: 300, overflow: 'auto' }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleScheduleFilterChange('userId', selectedKeys);
              }}
              size="small"
            ...
            <Button
              onClick={() => {
                clearFilters();
                handleScheduleFilterChange('userId', []);
                confirm();
              }}
              size="small"
              style={{ width: 90 }}
      ...
      filteredValue: scheduleFilters.userId,
    },
    {
      title: 'Ngày',
      dataIndex: 'date',
          ...
          <div style={{ padding: 8, maxHeight: 300, overflow: 'auto' }}>
            ...
            <div>
              <Button
                ...
                onClick={() => {
                  confirm();
                  handleScheduleFilterChange('date', selectedKeys);
                }}
                size="small"
                style={{ width: 90, marginRight: 8 }}
              >
              ...
              <Button
                onClick={() => {
                  clearFilters();
                  handleScheduleFilterChange('date', []);
                  confirm();
                }}
                size="small"
                style={{ width: 90 }}
      ...
      filteredValue: scheduleFilters.date,
    },
    {
      title: 'Ca làm việc',
      dataIndex: 'shift',
        ...
        <div style={{ padding: 8 }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleScheduleFilterChange('shift', selectedKeys);
              }}
              size="small"
              style={{ width: 90, marginRight: 8 }}
            >
            ...
            <Button
              onClick={() => {
                clearFilters();
                handleScheduleFilterChange('shift', []);
                confirm();
              }}
              size="small"
              style={{ width: 90 }}
      ...
      filteredValue: scheduleFilters.shift,
    },
    {
      title: 'Thời gian',
      dataIndex: 'startTime',
    ...
    },
    {
        ...
        <div style={{ padding: 8 }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleScheduleFilterChange('status', selectedKeys);
              }}
              size="small"
              style={{ width: 90, marginRight: 8 }}
            >
            ...
            <Button
              onClick={() => {
                clearFilters();
                handleScheduleFilterChange('status', []);
                confirm();
              }}
              size="small"
              style={{ width: 90 }}
      ...
      filteredValue: scheduleFilters.status,
    },
    {
      title: 'Tạo bởi',
      dataIndex: 'createdBy',
        ...
        <div style={{ padding: 8 }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleScheduleFilterChange('createdBy', selectedKeys);
              }}
              size="small"
              style={{ width: 90, marginRight: 8 }}
            >
            ...
            <Button
              onClick={() => {
                clearFilters();
                handleScheduleFilterChange('createdBy', []);
                confirm();
              }}
              size="small"
              style={{ width: 90 }}
      ...
      filteredValue: scheduleFilters.createdBy,
    },
    {
      title: 'Thao tác',
      key: 'action',
  ...
  const attendanceColumns = [
    {
        ...
        <div style={{ padding: 8, maxHeight: 300, overflow: 'auto' }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleAttendanceFilterChange('userId', selectedKeys);
              }}
              size="small"
              style={{ width: 90, marginRight: 8 }}
            >
            ...
            <Button
              onClick={() => {
                clearFilters();
                handleAttendanceFilterChange('userId', []);
                confirm();
              }}
              size="small"
              style={{ width: 90 }}
      ...
      onFilter: (value, record) => record.userId === value,
      filteredValue: attendanceFilters.userId,
    },
    {
      title: 'Ngày',
      dataIndex: 'date',
      ...
      defaultSortOrder: 'ascend',
      filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters }) => {
        const uniqueDates = Array.from(new Set(attendances.map(a => dayjs(a.date).format('YYYY-MM-DD'))));
          ...
          <div style={{ padding: 8, maxHeight: 300, overflow: 'auto' }}>
            ...
            <div>
              <Button
                ...
                onClick={() => {
                  confirm();
                  handleAttendanceFilterChange('date', selectedKeys);
                }}
                size="small"
                style={{ width: 90, marginRight: 8 }}
              >
              ...
              <Button
                onClick={() => {
                  clearFilters();
                  handleAttendanceFilterChange('date', []);
                  confirm();
                }}
                size="small"
                style={{ width: 90 }}
      ...
      onFilter: (value, record) => dayjs(record.date).format('YYYY-MM-DD') === value,
      filteredValue: attendanceFilters.date,
    },
    {
      title: 'Giờ vào',
      dataIndex: 'timeIn',
    ...
    },
    {
        ...
        <div style={{ padding: 8 }}>
          ...
          <div>
            <Button
              ...
              onClick={() => {
                confirm();
                handleAttendanceFilterChange('status', selectedKeys);
              }}
              size="small"
              style={{ width: 90, marginRight: 8 }}
            >
      ...
      onFilter: (value, record) => record.status === value,
      filteredValue: attendanceFilters.status,
    },
    {
      title: 'Ghi chú',
      dataIndex: 'note',
  ...
  const handleScheduleModalOk = () => {
    scheduleForm.validateFields().then(values => {
      ...
      // Kiểm tra lại ràng buộc thời gian trước khi gửi đi
      if (isShiftDisabled(formattedValues.shift, formattedValues.date)) {
        message.error(`Không thể phân công ca ${formattedValues.shift} do ràng buộc về thời gian`);
        return;
      }
  ...
  const isShiftDisabled = (shift, selectedDate) => {
    ...
    // Chỉ kiểm tra ràng buộc giờ cho ngày hiện tại
    if (scheduleDate.isSame(currentDate, 'day')) {
      ...
      // Trường hợp đặc biệt cho ca đêm: nếu đang phân công cho ngày hiện tại, 
      // ca đêm bắt đầu vào 00:00 của ngày hôm sau (tức là không thể phân công ca đêm cho ngày hiện tại)
      if (shift === 'night') {
        return true; // Luôn vô hiệu hóa ca đêm cho ngày hiện tại
      }
      
      // Xử lý các ca khác như bình thường
      const shiftStartDateTime = scheduleDate.hour(parseInt(shiftStartTime.split(':')[0])).minute(parseInt(shiftStartTime.split(':')[1]));
      
      // Nếu thời gian hiện tại đã vượt qua thời gian bắt đầu ca, disable
      if (currentDate.isAfter(shiftStartDateTime)) {
        return true;
      }
      
      // Nếu thời gian hiện tại gần thời gian bắt đầu ca ít hơn 30 phút, disable
      const minTimeBeforeShift = shiftStartDateTime.subtract(30, 'minute');
      if (currentDate.isAfter(minTimeBeforeShift)) {
        return true;
      }
    } 
    // Trường hợp đặc biệt cho ca đêm của ngày mai
    else if (scheduleDate.diff(currentDate, 'day') === 1 && shift === 'night') {
      // Kiểm tra nếu thời gian hiện tại quá gần với 00:00 của ngày mai (ít hơn 30 phút)
      const tomorrowMidnight = dayjs(scheduleDate).startOf('day');
      const timeUntilMidnight = tomorrowMidnight.diff(currentDate, 'minute');
      
      if (timeUntilMidnight < 30) {
        return true; // Vô hiệu hóa ca đêm nếu còn ít hơn 30 phút tới nửa đêm
      }
    }
    
    // Đối với các ngày trong tương lai (cách hơn 1 ngày), không có ràng buộc về giờ
    return false;
  };
  ...
  // Chức năng thiết lập bộ lọc lịch làm việc
  ...
  // Chức năng thiết lập bộ lọc chấm công
                ...
                >
                  <DatePicker 
                    ...
                    onChange={(date) => {
                      ...
                      // Reset ca làm việc khi thay đổi ngày để tránh lỗi
                      scheduleForm.setFieldsValue({ shift: undefined });
                    }}
