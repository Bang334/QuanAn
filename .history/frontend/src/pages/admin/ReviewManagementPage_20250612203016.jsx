                    ...
                    <TableRow key={review.id}>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                          ...
                          {review.user?.name || 'Người dùng không xác định'}
                        </Box>
                      </TableCell>
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Box sx={{ mb: 2, display: 'flex', alignItems: 'center' }}>
                  ...
                  <Box>
                    <Typography variant="h6">{currentReview.user?.name}</Typography>
                    <Typography variant="body2" color="textSecondary">
                      {currentReview.createdAt && format(new Date(currentReview.createdAt), 'dd/MM/yyyy HH:mm', { locale: vi })}
                    </Typography>
                  </Box>
                </Box>
              </Grid>
