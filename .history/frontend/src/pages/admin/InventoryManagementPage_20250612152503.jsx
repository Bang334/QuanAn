...
const InventoryManagementPage = () => {
  ...
  const filteredIngredients = ingredients.filter((ingredient) => {
    ...
    const matchesCategory = selectedCategory === 'all' || 
                            ingredient.categoryId === parseInt(selectedCategory) || 
                            (ingredient.category && ingredient.category === categories.find(c => c.id === parseInt(selectedCategory))?.name);
            ...
            filteredIngredients.map((ingredient) => {
              ...
              return (
                <TableRow key={ingredient.id}>
                  ...
                  <TableCell>{category ? category.name : (ingredient.category || '-')}</TableCell>
