      ...
      if (recipeData && recipeData.RecipeIngredients) {
        ...
        const ingredients = recipeData.RecipeIngredients.map(item => {
          return {
            ...
            price: item.Ingredient ? item.Ingredient.price : 0
          };
        });
            ...
            <Grid item xs={12}>
                  ...
                  <FormControl fullWidth>
                    ...
                    >
                      {ingredients.map((ingredient) => (
                        <MuiMenuItem key={ingredient.id} value={ingredient.id}>
                          {ingredient.name} ({formatPrice(ingredient.price)}/{ingredient.unit})
                        </MuiMenuItem>
                      ))}
                    </Select>
                  </FormControl>
              ...
              <List sx={{ mt: 2, bgcolor: 'background.paper' }}>
                {selectedIngredients.length > 0 ? (
                    ...
                    <React.Fragment key={index}>
                      <ListItem>
                        <ListItemText
                          ...
                          secondary={`${ingredient.quantity} ${ingredient.unit} - ${formatPrice(ingredient.price * ingredient.quantity)}`}
                        />
                        <ListItemSecondaryAction>
                  ...
                  <ListItem>
                    <ListItemText primary="Chưa có nguyên liệu nào được thêm" />
                  </ListItem>
                )}
              </List>
            </Grid>
