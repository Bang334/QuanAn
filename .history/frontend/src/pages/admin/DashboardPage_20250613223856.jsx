  ...
  return (
    <Box>
      ...
      <Grid container spacing={3}>
        {/* Biểu đồ thống kê doanh thu - Đã tăng kích thước và đặt ở trên đầu */}
        <Grid xs={12}>
          <Card>
            <CardHeader 
            ...
            <CardContent sx={{ p: 2 }}>
              {revenueData.length > 0 ? (
                ...
                <Box sx={{ height: 500, bgcolor: 'action.hover', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
