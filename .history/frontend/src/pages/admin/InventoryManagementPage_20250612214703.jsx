        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', mt: 1 }}>
                {Array.from({ length: 5 }).map((_, index) => (
                  <IconButton 
                    ...
                    sx={{ p: 0.5, color: index < supplierForm.rating ? '#FFB400' : '#C4C4C4' }}
                  >
          ...
          <Grid sx={{ gridColumn: '1/-1' }}>
            <FormControl component="fieldset" sx={{ mt: 2 }}>
              <Typography variant="body2" color="textSecondary" sx={{ mb: 1 }}>Trạng thái</Typography>
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <Button 
                  variant={supplierForm.isActive ? "contained" : "outlined"} 
                  color="success"
                  onClick={() => setSupplierForm({...supplierForm, isActive: true})}
                  sx={{ mr: 1 }}
                >
                  Đang hoạt động
                </Button>
                <Button 
                  variant={!supplierForm.isActive ? "contained" : "outlined"} 
                  color="error"
                  onClick={() => setSupplierForm({...supplierForm, isActive: false})}
                >
                  Không hoạt động
                </Button>
              </Box>
