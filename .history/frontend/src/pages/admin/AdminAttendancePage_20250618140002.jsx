...
const AdminAttendancePage = () => {
  ...
  const isShiftDisabled = (shift, selectedDate) => {
    ...
    // Tạo datetime cho thời điểm bắt đầu ca dựa trên ngày được chọn
    const shiftStart = scheduleDate.hour(parseInt(shiftStartTime.split(':')[0])).minute(parseInt(shiftStartTime.split(':')[1])).second(0);
