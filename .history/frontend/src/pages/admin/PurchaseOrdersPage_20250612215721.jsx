                  ...
                  <FormControl fullWidth required>
                    ...
                    <Select
                      ...
                      renderValue={(selected) => {
                        const selectedIngredient = ingredients.find(ing => ing.id === selected);
                        return (
                          <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            {selectedIngredient?.imageUrl || selectedIngredient?.image ? (
                              <Box 
                                component="img" 
                                src={selectedIngredient.imageUrl || selectedIngredient.image} 
                                alt={selectedIngredient.name}
                                sx={{ width: 30, height: 30, mr: 1, borderRadius: '4px', objectFit: 'cover' }}
                              />
                            ) : (
                              <Box 
                                sx={{ 
