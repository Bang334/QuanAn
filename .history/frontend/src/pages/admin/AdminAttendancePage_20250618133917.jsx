...
const AdminAttendancePage = () => {
  ...
  const isShiftDisabled = (shift, selectedDate) => {
    ...
    // Đặc biệt: Ca đêm luôn có thể chọn cho ngày hiện tại
    // Vì ca đêm (00:00-06:00) được xem là thuộc về ngày hiện tại, không phải ngày hôm sau
    if (shift === 'night') {
      return false;
    }
    
    // Đến đây nghĩa là đang xét ngày hiện tại, và ca không phải là ca đêm
