      ...
      if (recipeData && recipeData.RecipeIngredients) {
        ...
        const ingredients = recipeData.RecipeIngredients.map(item => {
          return {
            ...
            costPerUnit: item.Ingredient ? item.Ingredient.costPerUnit : 0
          };
        });
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
                              ...
                              <Box sx={{ flexGrow: 1 }}>
                                ...
                                <Typography variant="caption" color="text.secondary">
                                  {formatPrice(ingredient.costPerUnit || 0)}/{ingredient.unit}
                                </Typography>
                              </Box>
                            </Box>
                          </MuiMenuItem>
                        ...
                        <React.Fragment key={index}>
                          ...
                          >
                            <ListItemText
                              ...
                              secondary={
                                <Typography variant="caption" color="text.secondary">
                                  {ingredient.quantity} {ingredient.unit} - {formatPrice(ingredient.costPerUnit * ingredient.quantity)}
                                </Typography>
                              }
                            />
                          </ListItem>
