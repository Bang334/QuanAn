...
const InventoryManagementPage = () => {
  ...
  const renderInventoryOverview = () => {
    ...
    const lowStockCount = ingredients.filter(i => i.quantity <= i.minQuantity).length;
    const totalValue = ingredients.reduce((sum, i) => sum + (i.quantity * i.cost), 0);
            ...
            filteredIngredients.map((ingredient) => {
              ...
              return (
                <TableRow key={ingredient.id}>
                  ...
                  <TableCell align="right">
                    {new Intl.NumberFormat('vi-VN').format(ingredient.price || 0)}
                  </TableCell>
