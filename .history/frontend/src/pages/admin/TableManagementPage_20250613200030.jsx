    ...
    <Box sx={{ 
      ...
      >
        <DialogTitle sx={{ 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            {currentTable ? <EditIcon sx={{ mr: 1 }} /> : <AddIcon sx={{ mr: 1 }} />}
        ...
        <DialogContent sx={{ p: 3, mt: 2 }}>
          <Box sx={{ pt: 1 }}>
            <TextField
              ...
              placeholder="Bàn 1"
              InputProps={{
                startAdornment: <TableIcon sx={{ mr: 1, color: 'text.secondary' }} />,
              }}
            />
            ...
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="available" sx={{ display: 'flex', alignItems: 'center' }}>
                  <AvailableIcon sx={{ mr: 1, color: 'success.main' }} /> Trống
                </MenuItem>
                <MenuItem value="occupied" sx={{ display: 'flex', alignItems: 'center' }}>
                  <OccupiedIcon sx={{ mr: 1, color: 'error.main' }} /> Đang sử dụng
                </MenuItem>
                <MenuItem value="reserved" sx={{ display: 'flex', alignItems: 'center' }}>
                  <ReservedIcon sx={{ mr: 1, color: 'warning.main' }} /> Đã đặt trước
                </MenuItem>
              </Select>
            </FormControl>
          </Box>
        ...
        <DialogActions sx={{ px: 3, py: 2, bgcolor: 'background.default' }}>
          ...
          <Button 
            ...
            variant="contained" 
            color="primary"
            startIcon={currentTable ? <EditIcon /> : <AddIcon />}
            sx={{ 
              borderRadius: 2,
              boxShadow: '0 4px 10px rgba(0,0,0,0.15)',
              px: 3
              ...
              {selectedTableQR.qrCode ? (
                <Box>
                  ...
                  <Typography variant="body1" sx={{ mt: 2, fontWeight: 'medium' }}>
                    {selectedTableQR.name} - Sức chứa: {selectedTableQR.capacity} người
                  </Typography>
                ...
                <Box sx={{ py: 4 }}>
                  <Typography variant="h6" sx={{ mb: 2 }}>Chưa có mã QR cho bàn này</Typography>
                  <Typography variant="body2" color="text.secondary">
                    Tạo mã QR để khách hàng có thể quét và đặt món
                  </Typography>
                </Box>
              )}
              <Button 
