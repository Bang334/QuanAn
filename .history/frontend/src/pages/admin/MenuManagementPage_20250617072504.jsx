...
const MenuManagementPage = () => {
  ...
  const handleOpenDialog = async (item = null) => {
    if (item) {
      ...
      // Đặt dialog mở trước, sau đó mới tải công thức
      setOpenDialog(true);
      
      // Đợi một chút để dialog hiển thị
      setTimeout(async () => {
        try {
          // Tải công thức nấu ăn
  ...
  // Không cần hàm fetchRecipeForMenuItem nữa vì đã tích hợp vào handleOpenDialog
