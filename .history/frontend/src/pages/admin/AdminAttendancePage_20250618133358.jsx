...
const AdminAttendancePage = () => {
  ...
  const isShiftDisabled = (shift, selectedDate) => {
    ...
    // Trường hợp đặc biệt cho ca đêm ngày hôm nay:
    // Ca đêm bắt đầu lúc 00:00 của ngày mai, nhưng chúng ta đang phân công cho ngày hôm nay
    // Nên ca đêm ngày hôm nay luôn có thể được chọn (vì thực sự nó thuộc về 00:00 ngày mai)
    if (shift === 'night') {
      return false;
    }
