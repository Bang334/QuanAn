...
const KitchenPermissionManagementPage = () => {
  ...
  const handleOpenDialog = (permission = null) => {
    if (permission) {
      ...
      setFormData({
        ...
        canAddIngredients: permission.canAddIngredients || false,
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'canAutoApprove' || name === 'canAddIngredients') {
      setFormData({
        ...formData,
        [name]: checked
      });
  ...
  const handleSubmit = async () => {
    try {
      ...
      const permissionData = {
        ...
        canAddIngredients: formData.canAddIngredients,
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                ...
                <TableCell align="center">Tự động duyệt đơn</TableCell>
                <TableCell align="center">Thêm nguyên liệu</TableCell>
                  ...
                  >
                    ...
                    <TableCell align="center">
                      {permission.canAutoApprove ? (
                        <Tooltip title="Được phép tự động duyệt">
                          <CheckCircleIcon color="success" />
                        </Tooltip>
                      ) : (
                        <Tooltip title="Không được tự động duyệt">
                          <BlockIcon color="disabled" />
                        </Tooltip>
                      )}
                    </TableCell>
                    <TableCell align="center">
                      {permission.canAddIngredients ? (
                        <Tooltip title="Được phép thêm nguyên liệu">
                          <CheckCircleIcon color="success" />
                        </Tooltip>
                      ) : (
                        <Tooltip title="Không được thêm nguyên liệu">
                          <BlockIcon color="disabled" />
                        </Tooltip>
                      )}
                    </TableCell>
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid sx={{ gridColumn: '1/-1', mb: 2 }}>
              <FormControlLabel
                control={
                  <Switch
                    checked={formData.canAddIngredients}
                    onChange={handleInputChange}
                    name="canAddIngredients"
                    color="primary"
                  />
                }
                label="Cho phép thêm nguyên liệu (áp dụng cho tất cả nguyên liệu)"
              />
            </Grid>
            <Grid sx={{ gridColumn: '1/-1', mb: 2 }}>
              <TextField
